...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Restaurant = __webpack_require__(193);
			...
			value: function render() {
				if (this.props.places) {
					if (this.props.places.length > 1) {
						...
						var newElems = this.props.places.map(function (place) {
							return _react2.default.createElement(_Restaurant2.default, { key: place.place_id, name: place.name, address: place.address, phone: place.phone });
						});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = function (_React$Component) {
		...
		_createClass(Search, [{
			key: "setKeyword",
			value: function setKeyword(event) {
				this.setState({
			...
			value: function handleRes(res) {
				...
				res.forEach(function (obj) {
					...
					var req = { placeId: newObj.place_id };
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ id: "vegan-box" },
							_react2.default.createElement("input", { id: "vegan-input", name: "vegan", type: "checkbox", value: "Vegan", onChange: this.setVegan.bind(this) }),
							_react2.default.createElement(
								"label",
								{ "for": "vegan" },
								"Vegan"
						...
						_react2.default.createElement(
							"div",
							{ id: "gf-box" },
							_react2.default.createElement("input", { id: "gf-input", name: "gf", type: "checkbox", value: "Gluten-Free", onChange: this.setGf.bind(this) }),
							_react2.default.createElement(
								"label",
								{ "for": "gf" },
								"Gluten Free"
